<template>
  <div class="my-collect">
    <van-empty description="没有收藏的歌曲，快去收藏吧" v-if="collectList.length==0" />
    <div v-else>
      <ul>
        <li
        ...
        >
          ...
          />
          <!-- <div class="content fl">{{item.artist}}</div> -->
          <!-- 收藏图标 -->
          <div class="svg-icon fr">
            <span style="display:block" @click.stop="cancelCollect(item.songId)">
              <svg
                t="1595090008503"
                class="icon"
...
import MyCollect from "../../assets/js/MyCollect.js";
